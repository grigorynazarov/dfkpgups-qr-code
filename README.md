...
> Внимание! Инстркция рабочая, но они за место бар-кода теперь используют QR-код, но по меньше. Я потом это исправлю везде.
